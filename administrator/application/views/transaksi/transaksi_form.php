<section class="content-header">
    ...
    <div class="box-body">
        <div class="pull-right">
           ...
           <button type="submit" class="btn btn-primary">Batal Ajukan</button> 
        </div>
    </div>
    ...
    <!-- // Form input dan edit transaksi-->  	
        ...
        <!--END MODAL ADD BARANG-->
			...
			<div class="box-footer">
				<center>E-KINERJA <a href="http://www.polipangkep.ac.id"><strong>Politeknik Negeri Pangkajene Kepulauan</strong></a> - 2020</center>
			</div>
			<!-- /.box-footer-->
		  </div>
		  <!-- /.box -->
